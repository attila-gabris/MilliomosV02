...
public class Foablak extends javax.swing.JFrame {
    ...
    private final List<String> nyeremenyek; //Ebbe a listába kerülnek a nyeremények, nem változik.
    ...
    private Model model; //A szerializálást végző objektum
    ...
    * A nyitóképernyőn a gombok az init metódus által megjelenített lehetőségek szerint működnek. 
    ...
    private void btnValasz1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValasz1ActionPerformed
        if (init) {
            KerdesSzerkeszto ksz = new KerdesSzerkeszto(this, true, kerdesek); //Kérdésszerkesztő dialógus létrehozása
            ksz.setVisible(true); //A kérdésszerkesztő ablak indítása
            model.kerdesSer(kerdesek); //A kérdésszerkesztő ablak bezárása után szerializálja a kérdések listáját
    ...
    * megfelelően új kérdést jelenít meg, új játékot indít, vagy kilép.
    ...
    public void nevjegy() {
        label.setText("<html>Legyen Ön is milliomos v0.2 (hordozható változat)<br>Készítette: Gábris Attila<br>email: attila.gabris@gmail.com<br>"

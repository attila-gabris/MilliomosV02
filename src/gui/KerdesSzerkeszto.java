...
public class KerdesSzerkeszto extends javax.swing.JDialog {
     ...
     */
    public KerdesSzerkeszto(java.awt.Frame parent, boolean modal, List<Kerdes> kerdesek) {
        super(parent, modal);
        initComponents();
    ...
    private void btnUjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUjActionPerformed
        ...
        ka.setVisible(true); 
        if (ka.isMentes()) {
            int maxId = kerdesek.get(kerdesek.size()-1).getIdKerdesek() + 1; //Az új kérdés sorszáma
            ka.getKerdes().setIdKerdesek(maxId);
            kerdesek.add(ka.getKerdes()); //Az új kérdés hozzáadáasa a listához
